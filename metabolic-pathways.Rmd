...
```{r}
pheatmap(Jaccard_coefficients, color = colorRampPalette(brewer.pal(n = 7, name ="PuBu"))(100), main = "Jaccard Coefficients of hallmark genesets and metabolism genesets", fontsize_row = 5.25, fontsize_col = 6, fontsize = 10, angle_col = "315", cellwidth = 10, cellheight = 5)
```
...
Visualizing the similarity using a heatmap:
```{r}
pheatmap(Jaccard_coefficients_met, color = colorRampPalette(brewer.pal(n = 7, name ="PuBu"))(100), main = "Jaccard Coefficients of metabolism genesets to each other", fontsize_row = 5.25, fontsize_col = 6, fontsize = 10, angle_col = "315", cellwidth = 10, cellheight = 5)
```
...
Visualizing the similarity using a heatmap:
```{r}
pheatmap(Jaccard_coefficients_hall, color = colorRampPalette(brewer.pal(n = 7, name ="PuBu"))(100), main = "Jaccard Coefficients of hallmark genesets to each other", fontsize_row = 5.25, fontsize_col = 6, fontsize = 10, angle_col = "315", cellwidth = 10, cellheight = 5)
```
