...
```{r}
metabolism_list = list() #this creates an empty list to store the for loop in
...
```{r}
Jaccard_coefficients_hallmark = matrix(ncol = length(hallmark_list), nrow = length(metabolism_list), byrow = TRUE) #this creates an empty matrix to store the for loop in
