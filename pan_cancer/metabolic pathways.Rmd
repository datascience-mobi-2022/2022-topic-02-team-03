...
```{r}
pheatmap(Jaccard_coefficients, color = colorRampPalette(brewer.pal(n = 7, name ="PuBu"))(100), main = "Jaccard Coefficients of hallmark genesets and metabolism genesets", angle_col = "315", fontsize_row = 5.25, fontsize_col = 6)
```
