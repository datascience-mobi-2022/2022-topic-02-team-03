...
#normaler v.plot
pw.volc1 = ggplot(luad.info, aes(y = abs(spval), diff.mean, colour = expr, label = name))+
  geom_point(size = .5)+
  labs(title = paste("volcano plot pw: ", pw), x = "fc", y = "pwilc")+
  scale_color_manual(name = "title",
                     breaks = c(pw, "down", "not sign.", "up"),
...
ggsave(path = "C:/Users/felip/Desktop/plots", filename = paste(pw, "_volcano.png"), plot = pw.volc1)
