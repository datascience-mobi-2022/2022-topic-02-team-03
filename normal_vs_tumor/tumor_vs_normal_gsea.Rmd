...
#stats argument (ranked p values) needs to be a numeric
num.ranked.pvalues = as.numeric()


fgsea = fgsea(pathways = genesets$genesets[1], stats = rownames(ranked.pvalues))

#for(i in 1:length(genesets$genesets)){
#  fgsea = fgsea(pathways = genesets$genesets[[i]], stats = ranked.pvalues)
#}
