...
Gene set enrichment analysis (GSEA) is a computational method that is used to determine whether two gene expression states are significantly different from each other or not. In this project we compared gene expression profiles from different tumor types with each other as well as gene expression profiles between healthy and tumorous tissue of the same cancer type [@subramanian2007].
