...
rm(biotypes, biotypes_hallmarks, biotypes_metabol, biotypes.cut, genesets, luad.normal.cut, luad.tumor.cut, mmv_df_cut, colnames, i, IDs.cut, left.genes, relevant_biotypes, metabolism_list_gs)
```
