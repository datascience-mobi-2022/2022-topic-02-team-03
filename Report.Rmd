...
The results indicate low cellular response to LDL particles in tumor tissue samples. As seen in (\textbf{Fig. \ref{fig:volcano pathways}}) (bottom right), peroxisome proliferator-activated receptor gamma (PPAR<i>gamma</i>) is significantly downregulated. PPAR<i>gamma</i> is proven to be involved in inhibition of development of primary tumors and metastases formation in lung cancer and may also function as a tumor suppressor [@Aravind2016]. Moreover CD36 has different expression rates at different cancer stages. CD36 expression is invariably low in the *in situ* stage but rises when cells begin to metastasize [@Wang2019].
