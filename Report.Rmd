...
Uniform manifold approximation and projection (UMAP) is a k-neighbour graph based algorithm that is used for non-linear dimension reduction [@smets2019] [@mcinnes2018].
