...
The Cancer Genome Atlas (TCGA) is a is a publicly available collection of datasets that store the most important cancer-causing genomic alterations in order to create an 'atlas' of cancer genomic profiles[@tomczak2015]. It also provides a vast amount of RNA-seq data that makes it possible to go beyond static genome analysis and to gain an insight into the transcriptional activity of a cell [@marguerat2010].
